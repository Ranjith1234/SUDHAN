...
INSERT INTO `customermaster` VALUES (1,'2017-02-13 00:00:00','321321','123123','address','2017-02-13','city','contact name','1231231230','admin',NULL,'Rajkumar','test@gmail.com','fax123','1234567890','123456','Active','www.test.com',1,1),(2,NULL,NULL,'123','my address','2017-02-13','city',NULL,NULL,'admin',NULL,'test user name',NULL,NULL,NULL,'123','Active',NULL,1,1),(3,NULL,'cst','12312','address','2017-02-13','city',NULL,NULL,'admin',NULL,'New customer',NULL,NULL,NULL,'123123','Active',NULL,1,1),(4,NULL,NULL,'12453','test address','2017-06-23','Coimbatore',NULL,NULL,'admin',NULL,'Rajkuamr',NULL,NULL,NULL,'1234','Active',NULL,1,1),(5,NULL,NULL,NULL,'Test Address','2017-06-28','Test City','','',NULL,NULL,'Testing REST Customer','test@gmail.com','','','125wa','Active','',1,1),(6,NULL,NULL,'124','add','2017-06-30','ci',NULL,NULL,'admin',NULL,'Thist is  test',NULL,NULL,NULL,'123','Active',NULL,1,1),(7,NULL,'cvbvn','3456','dsfghf','2017-07-04','fgdhg',NULL,NULL,'admin',NULL,'asdfsgfdh',NULL,NULL,NULL,'dfsgh','Active',NULL,1,1),(8,'2017-07-05 00:00:00','145423','1232542','address','2017-07-05','city','test contact','245326342','admin',NULL,'Customer name','test@gmail.com','263426542','1245435345','123124','Active','www.google.com',1,1),(9,'2017-07-06 00:00:00','454657','4354675','test','2017-07-05','cads','345','435647568','admin',NULL,'helllo','yrdy@dg.fgh','454657o8','3456657','35`','Active','www.dg.df',1,1),(10,'2017-07-05 00:00:00','3456','2345','dfdghjg','2017-07-05','sdfgfh','fgdhfh','dsfgdhfd','admin',NULL,'rdstfgjg','sdaf@df.gds','4567','345676','3456','Active','www.sadg.sdf',1,1),(11,'2017-07-05 00:00:00','3454','2345','address','2017-07-05','city','sfgdhf','sfdsgfh','admin',NULL,'Customer Name','sdaf@sdf.sdf','564869786','21324567','12445','Active','asfhdgfhmg',1,1),(12,'2017-07-12 00:00:00','c','123','ad','2017-07-05','c',NULL,NULL,'admin',NULL,'test',NULL,NULL,'4354','234','Active',NULL,1,1);
...
INSERT INTO `module` VALUES (1,'','fa fa-th','Dashboard',1,'#dashboard.do',NULL),(2,'','fa fa-users','Customer',2,'#',NULL),(3,'',NULL,'New Customer',1,'#newcustomer.do',2),(4,'','fa fa-user-circle-o','User Management',3,'#',NULL),(5,'',NULL,'New User',3,'#',4),(6,'',NULL,'Multi Menu Test',1,'#',5),(7,'','fa fa-car','Test Sub-Menu',2,'#',2),(8,'','fa fa-car','Test Sub-Menu',1,'#',7);
...
-- Dump completed on 2017-07-10 20:08:10
